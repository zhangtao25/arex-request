...
export function useEnvCodeMirror(props) {
    const { value, initialState, root, onCreateEditor, theme = 'light', extensions, height, onStatistics, onChange, currentEnv, } = props;
    ...
    function markFn() {
        if (view) {
            ...
            const addFoundMarks = StateEffect.define();
            const addNotFoundMarks = StateEffect.define();
